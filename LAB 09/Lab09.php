    ...
    <main class="container">
        ...
        <div class="btn-group countryButtons" role="group" aria-label="...">
              ...
              //<a href="list.php?country=Canada" role="button" class="btn btn-default"> Canada</a> 
               $countryNames = array("CA","DE","GR","IT","GB","US");
                 foreach ($countryNames as $value)
                  {
                  global$countries;
                     echo '<a href="list.php?country='.$countries[$value].'" role="button" class="btn btn-default">'.$countries[$value].'</a> ';
                }
...
global$images;
echo '<li>';
echo '<a href="detail.php?id='.$value.'" class="img-responsive">';
echo '<img src="images/square/'.$images[$value]['path'].'" alt="'.$images[$value]['title'].'">';
echo '<div class="caption">';
echo '<div class="blur">';
echo '</div>';
echo '<div class="caption-text">';
echo '<h1>'.$images[$value]['title'].'</h1>';
echo '</div>';
echo '</div>';
echo '</a>';
echo '</li>';
